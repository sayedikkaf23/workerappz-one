...
export class LocationManagement {
     ...
     isLoading = false; // Loader state
        cities:any[] = []; // Array to hold all categories
        ...
        handleCategoryAdded(location: { countryName: string, cityName: string, locationName: string }) {
          console.log('city added:', location);
        ...
        loadCurrencies(): void {
          ...
          this.adminService.getCurrencies().subscribe(
           ...
           this.cities = res.data;
                this.filteredCategories = this.cities;
        ...
        filterCurrencies(): void {
          ...
          if (!searchTermLower) {
            ...
            this.filteredCategories = this.cities.filter(category => {
