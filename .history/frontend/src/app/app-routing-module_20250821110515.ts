...
const routes: Routes = [
  ...
  // { path: 'admin/admindashboard', component: AdminDashboard },
  {
    ...
    children: [
      ...
      { path: 'master/currency', component: CurrencyManagement },
     ...
     //MASTER  // Country Management
      ...
      { path: 'master/mode-of-payment', component: ModeOfPayment},
       { path: 'master/permission-list', component: PermissionList},
       { path: 'master/city-management', component: CityManagement},
        { path: 'master/location-management', component: CityManagement},
    ],
  },
];
